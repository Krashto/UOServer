...
{
    public abstract class BaseStamMaxBuffFood : BaseBuffFood
	{
        public BaseStamMaxBuffFood(BuffFoodEffect effect)
            : base(0x3C10, effect)
        {
        }

        public BaseStamMaxBuffFood(Serial serial)
            : base(serial)
        {
        }

        public abstract int StamMaxOffset { get; }
