...
namespace Server.Custom.Races
{
	class Imperial : BaseRace
	{
		...
		public override BaseRaceGumps GetSkin(int hue)
		{
			...
			return new CorpsImperial(itemId, hue);
		}
...
{
	public class CorpsImperial : BaseRaceGumps
	{
		[Constructable]
		public CorpsImperial() : this(0)
		{
		}

		[Constructable]
		public CorpsImperial(int id, int hue) : base(id, hue)
		{
			Name = "Imperial";
		}

		public CorpsImperial(Serial serial)
			: base(serial)
		{
		}
