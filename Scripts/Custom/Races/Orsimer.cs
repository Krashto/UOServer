...
namespace Server.Custom.Races
{
	class Orsimer : BaseRace
	{
		...
		public override BaseRaceGumps GetSkin(int hue)
		{
			...
			return new CorpsOrsimer(itemId, hue);
		}
...
{
	public class CorpsOrsimer : BaseRaceGumps
	{
		[Constructable]
		public CorpsOrsimer() : this(0)
		{
		}

		[Constructable]
		public CorpsOrsimer(int id, int hue) : base(id, hue)
		{
			Name = "Orsimer";
		}

		public CorpsOrsimer(Serial serial)
			: base(serial)
		{
		}
