...
namespace Server.Items
{
    ...
    {
        [Constructable]
        public CorpsKroise() : this(0)
        {
        }

        [Constructable]
        public CorpsKroise(int Id, int hue) : base(Id, hue)
        {
            Name = "Kroise";
        }

        public CorpsKroise(Serial serial) : base(serial)
        {
        }
