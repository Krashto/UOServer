...
namespace Server.Gumps
{
    public class QuiGump : Gump
    {
        ...
        private class InternalComparer : IComparer
        {
            ...
            public int Compare(object x, object y)
            {
                ...
                if (a.AccessLevel > b.AccessLevel)
                    ...
                    retour = Insensitive.Compare(a.Name, b.Name);

                if (a.Name.Equals("Anonyme"))
                    return 1;
                else if (b.Name.Equals("Anonyme"))
                    return -1;
                else
                    return retour;
            }
        ...
        private static int GetHueFor(Mobile m)
        {
            switch (m.AccessLevel)
            {
                ...
                case AccessLevel.Administrator: return 0x144;
                ...
                case 3: // Options
                    {
                        if(from is CustomPlayerMobile)
                            from.SendGump(new QuiOptionsGump((CustomPlayerMobile)from));
                        break;
                    }
                default:
                    {
    ...
    public class QuiOptionsGump : Gump
    {
		...
		CustomPlayerMobile owner;

        public QuiOptionsGump(CustomPlayerMobile from) : base(30, 30)
        {
            owner = from;
