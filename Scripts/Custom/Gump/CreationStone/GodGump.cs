...
namespace Server.Gumps
{
  public class CreationGodGump : CreationBaseGump
    {
        public CreationGodGump(CustomPlayerMobile from, CreationPerso creationPerso) : base(from, creationPerso, "Choix du dieu",true, creationPerso.God != null)
        {
            ...
            string GodBG = "Aucune divinité sélectionnée";
