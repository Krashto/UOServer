...
namespace Server
{
	...
	public class SlaveEntry
	{
		...
		public SlaveEntry(Race race, int hue, AppearanceEnum appareance, GrandeurEnum grandeur, CorpulenceEnum grosseur, string name, bool female)
		{
			m_Race = race;
			m_Hue = hue;
			m_female = female;
		...
		public SlaveEntry()
		{
			...
			m_Grosseur = (CorpulenceEnum)Utility.Random(1, Enum.GetNames(typeof(CorpulenceEnum)).Length - 1); ;
		...
		public int GrosseurCost()
		{
			...
			switch (m_Grosseur)
			{
				case CorpulenceEnum.None:
					break;
				case CorpulenceEnum.Fluet:
					GrosseurCost -= 500;
					break;
				case CorpulenceEnum.Maigre:
					GrosseurCost += 250;
					break;
				case CorpulenceEnum.Mince:
					GrosseurCost += 1000;
					break;
				case CorpulenceEnum.Elance:
					GrosseurCost += 1000;
					break;
				case CorpulenceEnum.Svelte:
					GrosseurCost += 1000;
					break;
				case CorpulenceEnum.Bedonnant:
					GrosseurCost -= 500;
					break;
				case CorpulenceEnum.BienEnChair:
					GrosseurCost -= 750;
					break;
				case CorpulenceEnum.Corpulent:
					GrosseurCost -= 1000;
					break;
				default:
					break;
