...
namespace Server
{
	public class HydromancienClasse
    {
        private static string m_Name = "Hydromancien";
        private static Classe m_Classe = Classe.Hydromancien;
        ...
        private static CAptitudes[] m_Aptitudes = new CAptitudes[]
            {
                new CAptitudes(Aptitude.Hydromancie, 10),
            };
