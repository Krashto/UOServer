...
namespace Server.Custom.Classes
{
    ...
    public sealed class Classes
    {
        ...
        public static ClasseInfo GetInfos(Classe classe)
        {
            ...
            switch (classe)
            {
                case Classe.Acrobate: info = AcrobateClasse.ClasseInfo; break;
                case Classe.LanceurDeCouteaux: info = LanceurDeCouteauxClasse.ClasseInfo; break;
                case Classe.DanseurDeLames: info = DanseurDeLameClasse.ClasseInfo; break;
                ...
                case Classe.Brute: info = BruteClasse.ClasseInfo; break;
                case Classe.Barbare: info = BarbareClasse.ClasseInfo; break;
                case Classe.Berseker: info = BersekerClasse.ClasseInfo; break;

                case Classe.Ecuyer: info = EcuyerClasse.ClasseInfo; break;
                case Classe.Jouteur: info = JouteurClasse.ClasseInfo; break;
                case Classe.Chevalier: info = ChevalierClasse.ClasseInfo; break;
                ...
                case Classe.Prestidigitateur: info = PrestidigitateurClasse.ClasseInfo; break;
                ...
                case Classe.Canalisateur: info = CanalisateurClasse.ClasseInfo; break;

                case Classe.Mage: info = MageClasse.ClasseInfo; break;
                case Classe.Magicien: info = MagicienClasse.ClasseInfo; break;
                case Classe.Thaumaturge: info = ThaumaturgeClasse.ClasseInfo; break;

                case Classe.Herboriste: info = HerboristeClasse.ClasseInfo; break;
