...
{
	public class MurDeLumiereSpell : Spell
	{
		private static SpellInfo m_Info = new SpellInfo(
				"Mur de lumiere", "[Mur de lumiere]",
				SpellCircle.First,
				212,
				9061,
				Reagent.Garlic,
		...
		public MurDeLumiereSpell(Mobile caster, Item scroll)
		...
		{
			private readonly MurDeLumiereSpell m_Owner;
			public InternalTarget(MurDeLumiereSpell owner)
