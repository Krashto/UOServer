...
namespace Server.Custom.Spells.NewSpells.Pyromancie
{
	...
	public class FamilierGump : Gump
	{
		...
		public FamilierGump(Mobile from, FamilierEntry[] entries) : base(200, 100)
		{
			...
			var necro = from.Skills[SkillName.Magery].Base;
			var spirit = from.Skills[SkillName.SpiritSpeak].Base;
		...
		public override void OnResponse(NetState sender, RelayInfo info)
		{
			...
			if (index >= 0 && index < m_Entries.Length)
			{
				...
				var necro = m_From.Skills[SkillName.Magery].Base;
				var spirit = m_From.Skills[SkillName.SpiritSpeak].Base;
				...
				else if (entry.Type == null)
				{
					...
					try
					{
						...
						if (BaseCreature.Summon(bc, m_From, m_From.Location, -1, TimeSpan.FromSeconds(10 + m_From.Skills[SkillName.Magery].Base * 2.4)))
						{
