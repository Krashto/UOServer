...
namespace Server.Custom.Spells.NewSpells.General
{
...

	{
		...
		{
			return TimeSpan.FromSeconds(10); // 15/8/10 Up a 10 sec de cast par Dagalbert
		}
		...
		public RappelSpell(Mobile caster, Item scroll) : this(caster, scroll, null, null)
		{
		}
		...
		{
			private RappelSpell m_Owner;

			public InternalTarget(RappelSpell owner)
