	...
	public class RevelationSpell : Spell
	{
		...
		public void Target( IPoint3D p )
		{
			...
			else if ( CheckSequence() )
			{
				...
				if ( map != null )
				{
                    double tile = SpellHelper.AdjustValue(Caster, 4 + (int)(Caster.Skills[SkillName.Magery].Value / 50.0), NAptitude.Defense);
...
//				return true;
            ...
            double sourceSkill = from.Skills[SkillName.Magery].Value;
            double targetSkill = m.Skills[SkillName.Hiding].Value;
            double value;
