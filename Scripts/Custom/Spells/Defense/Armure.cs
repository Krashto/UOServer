...
namespace Server.Spells
{
	public class ArmureSpell : Spell
	{
        ...
        {
            double value = 10 + Caster.Skills[SkillName.Magery].Value + Caster.Skills[SkillName.EvalInt].Value;
            value /= 1.5;
            ...
            value = SpellHelper.AdjustValue(Caster, value, NAptitude.Defense);
