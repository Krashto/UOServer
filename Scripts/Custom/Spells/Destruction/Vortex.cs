        ...
        private class VortexTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                else 
                {
                    ...
                    if (map != null)
                    {
                        IPooledEnumerable eable = map.GetMobilesInRange(new Point3D(loc), (int)SpellHelper.AdjustValue(m_caster, 1 + m_caster.Skills[SkillName.Magery].Base / 25, NAptitude.Destruction));
