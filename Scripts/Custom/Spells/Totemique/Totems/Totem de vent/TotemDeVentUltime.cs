...
namespace Server.Custom.Spells.NewSpells.Totemique
{
	...
	public class TotemDuVentUltime : BaseTotemDeVent
	{
		[Constructable]
		public TotemDuVentUltime() : base(AIType.AI_Melee, FightMode.Closest, 10, 1)
		{
			Name = "Totem du vent";
			Body = 13;
			Hue = 0x4001;
		...
		public TotemDuVentUltime(Serial serial)
			: base(serial)
		{
		}
