...
namespace Server.Custom.Spells.NewSpells.Totemique
{
	...
	public class TotemDeTerreUltime : BaseTotemDeTerre
	{
		[Constructable]
		public TotemDeTerreUltime() : base(AIType.AI_Melee, FightMode.Closest, 10, 1)
		{
			Name = "Totem de terre";
			Body = 14;
			BaseSoundID = 268;
		...
		public TotemDeTerreUltime(Serial serial)
			: base(serial)
		{
		}
