	...
	public class MurDePoisonSpell : Spell
	{
		...
		private class InternalItem : Item
		{
            ...
            public void ApplyPoisonTo(Mobile m)
            {
                ...
                double total = m_Caster.Skills[SkillName.Magery].Value + m_Caster.Skills[SkillName.Poisoning].Value;
		...
		{
            private MurDePoisonSpell m_Owner;

            public InternalTarget(MurDePoisonSpell owner)
