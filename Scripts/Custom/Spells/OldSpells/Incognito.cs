...
namespace Server.Spells.OldSpells
{
	public class IncognitoSpell : Spell
	{
        ...
        public override int RequiredAptitudeValue { get { return 50; } }
        public override int RequiredMagicCapacity { get { return 5; } }
		...
		public override void OnCast()
        {
            ...
            //    Caster.SendMessage("Vous ne pouvez faire ce sort en étant transformé.");
            //}
            //else if (Caster is CustomPlayerMobile && ((CustomPlayerMobile)Caster).Disguised)
            //{
		...
		private class InternalTimer : Timer
		{
			...
			public InternalTimer( Mobile owner ) : base( TimeSpan.FromSeconds( 0 ) )
			{
				...
				double val = (owner.Skills[SkillName.Magery].Value * 8) + 120;
