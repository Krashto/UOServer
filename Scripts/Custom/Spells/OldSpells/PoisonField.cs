	...
	public class PoisonFieldSpell : Spell
	{
		...
		public void Target( IPoint3D p )
		{
			...
			else if ( /*SpellHelper.CheckTown( p, Caster ) && */CheckSequence() )
			{
                ...
                double duration = 4.0 + (Caster.Skills[SkillName.Magery].Value * 0.4);
		...
		public class InternalItem : Item
		{
            ...
            public void ApplyPoisonTo(Mobile m)
            {
                ...
                double total = (m_Caster.Skills[SkillName.Magery].Value + m_Caster.Skills[SkillName.Poisoning].Value) / 2;
