...
//		public override int CastDelayBase{ get{ return base.CastDelayBase - 1; } }
		...
		public void Target( IPoint3D p )
		{
			...
			else if ( CheckSequence() )
			{
				...
				if ( map != null )
				{
                    IPooledEnumerable eable = map.GetMobilesInRange(new Point3D(p), (int)SpellHelper.AdjustValue(Caster, 1 + Caster.Skills[SkillName.Magery].Value / 50, NAptitude.Medecine));
