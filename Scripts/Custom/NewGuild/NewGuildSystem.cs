...
namespace Server.Custom.System
{
   ...
   public class NewGuildRank
	...
	public class GuildRecruter : BaseVendor
	{
		...
		public int GeCustomPlayerMobileRank(CustomPlayerMobile cm)
		{
			CustomGuildMember cgm = GeCustomPlayerMobileInfo(cm);
		...
		public CustomGuildMember GeCustomPlayerMobileInfo(CustomPlayerMobile cm)
		{
			return GeCustomPlayerMobileInfo(cm, cm.IdentiteID);

		}

		public CustomGuildMember GeCustomPlayerMobileInfo(CustomPlayerMobile cm, int identite)
		{
			foreach (CustomGuildMember item in m_Members)
			{
 ...
 */
        ...
        public void AddGuildMember(Mobile m)
        {
			...
			{
				if (GeCustomPlayerMobileInfo(cm) == null)
				{
