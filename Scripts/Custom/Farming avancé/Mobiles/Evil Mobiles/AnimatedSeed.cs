...
namespace Server.Mobiles
{
	public class AnimatedSeed : BaseCreature
	{
		...
		public AnimatedSeed() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
            this.Body = 903;
            this.Hue = 0x5E2;
            this.Name = "Animated Seed";

            this.SetStr(351, 380);
            this.SetDex(251, 280);
            this.SetInt(51, 80);

            this.SetHits(478, 501);
            ...
            this.SetResistance(ResistanceType.Cold, 60, 90);
            this.SetResistance(ResistanceType.Poison, 200);
            this.SetResistance(ResistanceType.Energy, 20, 30);

            this.SetSkill(SkillName.Wrestling, 100.0, 150.0);
            this.SetSkill(SkillName.Tactics, 100.0, 150.0);
            this.SetSkill(SkillName.MagicResist, 200.0, 350.0);
