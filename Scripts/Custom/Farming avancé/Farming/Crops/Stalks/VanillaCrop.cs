...
{
	public class VanillaSeed : BaseCrop
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			this.Consume();
			Item item = new VanillaSeedling( from );
			item.Location = m_pnt;
			item.Map = m_map;
		}
	...
	public class VanillaSeedling : BaseCrop
	{
        ...
        public static void init( VanillaSeedling plant)
		{
            plant.thisTimer = new CropHelper.GrowTimer(plant, typeof(VanillaCrop), plant.Sower);
	...
	public class VanillaCrop : BaseCrop
	{
		...
		{
            private VanillaCrop i_plant;
			public CropTimer( VanillaCrop plant ) : base( TimeSpan.FromSeconds( 450 ), TimeSpan.FromSeconds( 15 ) )
			{
