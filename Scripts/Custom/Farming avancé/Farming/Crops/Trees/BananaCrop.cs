...
{
	public class BananaSeed : BaseCrop
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			this.Consume();
			Item item = new BananaSeedling( from );
			item.Location = m_pnt;
			item.Map = m_map;
		}
	...
	public class BananaSeedling : BaseCrop
	{
		...
		public static void init( BananaSeedling plant )
		{
			plant.thisTimer = new CropHelper.GrowTimer( plant, typeof(BananaCrop), plant.Sower );
	...
	public class BananaCrop : BaseCrop
	{
		...
		public static void init ( BananaCrop plant, bool full )
		{
			plant.PickGraphic = ( 0xCAA );
			plant.FullGraphic = ( 0xCAA );
		...
		{
			private BananaCrop i_plant;
			public CropTimer( BananaCrop plant ) : base( TimeSpan.FromSeconds( 450 ), TimeSpan.FromSeconds( 15 ) )
			{
