...
{
	public class MiniAvocadoSeed : BaseCrop
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			this.Consume();
			Item item = new MiniAvocadoSeedling( from );
			item.Location = m_pnt;
			item.Map = m_map;
		}
	...
	public class MiniAvocadoSeedling : BaseCrop
	{
		...
		public static void init( MiniAvocadoSeedling plant )
		{
			plant.thisTimer = new CropHelper.GrowTimer( plant, typeof(MiniAvocadoCrop), plant.Sower );
	...
	public class MiniAvocadoCrop : BaseCrop
	{
		...
		public static void init ( MiniAvocadoCrop plant, bool full )
		{
		...
		{
			private MiniAvocadoCrop i_plant;
			public CropTimer( MiniAvocadoCrop plant ) : base( TimeSpan.FromSeconds( 450 ), TimeSpan.FromSeconds( 15 ) )
			{
