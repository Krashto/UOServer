...
{
	public class MiniMangoSeed : BaseCrop
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			this.Consume();
			Item item = new MiniMangoSeedling( from );
			item.Location = m_pnt;
			item.Map = m_map;
		}
	...
	public class MiniMangoSeedling : BaseCrop
	{
		...
		public static void init( MiniMangoSeedling plant )
		{
			plant.thisTimer = new CropHelper.GrowTimer( plant, typeof(MiniMangoCrop), plant.Sower );
	...
	public class MiniMangoCrop : BaseCrop
	{
		...
		public static void init ( MiniMangoCrop plant, bool full )
		{
		...
		{
			private MiniMangoCrop i_plant;
			public CropTimer( MiniMangoCrop plant ) : base( TimeSpan.FromSeconds( 450 ), TimeSpan.FromSeconds( 15 ) )
			{
