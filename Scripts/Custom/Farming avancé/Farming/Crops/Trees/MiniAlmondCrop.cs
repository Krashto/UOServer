...
{
	public class MiniAlmondSeed : BaseCrop
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			this.Consume();
			Item item = new MiniAlmondSeedling( from );
			item.Location = m_pnt;
			item.Map = m_map;
		}
	...
	public class MiniAlmondSeedling : BaseCrop
	{
		...
		public static void init( MiniAlmondSeedling plant )
		{
			plant.thisTimer = new CropHelper.GrowTimer( plant, typeof(MiniAlmondCrop), plant.Sower );
	...
	public class MiniAlmondCrop : BaseCrop
	{
		...
		public static void init ( MiniAlmondCrop plant, bool full )
		{
		...
		{
			private MiniAlmondCrop i_plant;
			public CropTimer( MiniAlmondCrop plant ) : base( TimeSpan.FromSeconds( 450 ), TimeSpan.FromSeconds( 15 ) )
			{
