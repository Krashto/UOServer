...
namespace VitaNex.FX
{
	...
	public class BloodPentagramEffect : BaseSpecialEffect
	{
		public static EffectInfo[] Info
		{
			get
			{
				return new[]
				{
					new EffectInfo(null, null, 0x122B, 0, 10, 20, EffectRender.SemiTransparent),
					new EffectInfo(null, null, 0x374A, 0, 10, 20, EffectRender.Normal, TimeSpan.FromMilliseconds(200))
				};
			}
		}
