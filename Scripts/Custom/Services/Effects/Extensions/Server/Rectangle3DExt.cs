	...
	public static class Rectangle3DExtUtility
	{
		...
		public static IEnumerable<Point3D> EnumeratePoints(this Rectangle3D r)
		{
			if (r.Depth > 10)
			{
				...
				Console.WriteLine("> Warning!"); //"> Warning!".ToConsole();
				Console.WriteLine("> Rectangle3DExtUtility.EnumeratePoints() called on Rectangle3D with depth exceeding 10;");//.ToConsole();
				Console.WriteLine("> This may cause serious performance issues.");//.ToConsole();
				Utility.PopColor();
			}
		...
		public static IEnumerable<Point3D> GetBorder(this Rectangle3D r, int size)
		{
			...
			{
				Utility.PushColor(ConsoleColor.Yellow);
				Console.WriteLine("> Warning!");//.ToConsole();
				Console.WriteLine("> Rectangle3DExtUtility.EnumeratePoints() called on Rectangle3D with depth exceeding 10;");//.ToConsole();
				Console.WriteLine("> This may cause serious performance issues.");//.ToConsole();
				Utility.PopColor();
			}
