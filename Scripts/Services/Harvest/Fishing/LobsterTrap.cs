...
namespace Server.Items
{
    ...
    public class LobsterTrap : Container, ITelekinesisable, IBaitable
    {
        ...
        public void OnTick()
        {
            ...
            if (m_Owner != null && (!SpecialFishingNet.ValidateDeepWater(Map, X, Y) || m_Owner.Skills[SkillName.Cooking].Base >= 75.0))
            {
                m_Owner.CheckSkill(SkillName.Cooking, 0, m_Owner.Skills[SkillName.Cooking].Cap);
            }
