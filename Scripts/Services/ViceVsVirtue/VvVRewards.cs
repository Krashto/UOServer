...
namespace Server.Engines.VvV
{
    ...
    public static class VvVRewards
    {
        ...
        public static void Initialize()
        {
            ...
            Rewards.Add(new CollectionItem(typeof(VvVPlateArms), 776, 0, 0, 500));
            ...
            Rewards.Add(new CollectionItem(typeof(VvVEpaulette), 0x9986, 0, 0, 500));
            Rewards.Add(new CollectionItem(typeof(VvVStuddedChest), 5083, 0, 0, 500));
            Rewards.Add(new CollectionItem(typeof(VvVEarrings), 16915, 0, 0, 500));
