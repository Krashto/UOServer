...
namespace Server.Items
{
  ...
  */
            ...
            new Type[][] // Ranger
                {
                    ...
                    null,
                    new Type[] { typeof(Bow), typeof(Crossbow), typeof(HeavyCrossbow), typeof(CompositeBow), typeof(ButcherKnife), typeof(SkinningKnife), typeof(ButcherKnife), typeof(Cyclone), typeof(SoulGlaive) },
                    null,
                },
            new Type[][] // Warrior
                {
        ...
        private static readonly Type[][][] _ArmorTable = new Type[][][]
        {
            new Type[][] // Artisan
                {
                    new Type[] { typeof(Bonnet), typeof(Cap), typeof(Circlet), typeof(ElvenGlasses), typeof(FeatheredHat),  typeof(JesterHat), typeof(SkullCap), typeof(StrawHat), typeof(TallStrawHat), typeof(WideBrimHat) }, // Trammel/Fel
                    null, // Ilshenar
                    null, // Malas
                    null, // Tokuno
                    null, // TerMur
                    new Type[] { typeof(Bonnet), typeof(Cap), typeof(Circlet), typeof(ElvenGlasses), typeof(FeatheredHat),  typeof(JesterHat), typeof(SkullCap), typeof(StrawHat), typeof(TallStrawHat), typeof(WideBrimHat), typeof(ChefsToque) }, // Eodon
                },
            new Type[][] // Assassin
                {
            ...
            new Type[][] // Warrior
                {
                    ...
                    new Type[] { typeof(PlateLegs), typeof(PlateHelm), typeof(PlateGorget), typeof(PlateGloves), typeof(PlateChest), typeof(PlateArms), typeof(Bascinet), typeof(CloseHelm), typeof(Helmet), typeof(LeatherCap), typeof(NorseHelm), typeof(TricorneHat), typeof(BronzeShield), typeof(Buckler), typeof(ChaosShield), typeof(HeaterShield), typeof(MetalKiteShield), typeof(MetalShield), typeof(OrderShield), typeof(WoodenKiteShield), typeof(PlateArms), typeof(PlateChest), typeof(PlateLegs), typeof(PlateArms) }, // TerMur
        ...
        {
            new Type[] {  typeof(OakBoard), typeof(AshBoard), typeof(DullCopperIngot), typeof(ShadowIronIngot), typeof(CopperIngot), typeof(LupusLeather), typeof(ReptilienLeather), typeof(GeantLeather) },
            new Type[] { typeof(YewBoard), typeof(HeartwoodBoard), typeof(BronzeIngot), typeof(GoldIngot), typeof(AgapiteIngot), typeof(OphidienLeather), typeof(ArachnideLeather), typeof(DragoniqueLeather) },
            new Type[] {  typeof(BloodwoodBoard), typeof(FrostwoodBoard), typeof(ValoriteIngot), typeof(VeriteIngot), typeof(DemoniaqueLeather), typeof(AncienLeather) }
        };
        ...
        public static SkillName[][] _TranscendenceTable = new SkillName[][]
            {
                ...
                new SkillName[] { SkillName.Anatomy, SkillName.DetectHidden, SkillName.Fencing, SkillName.Poisoning, SkillName.RemoveTrap, SkillName.Snooping, SkillName.Equitation },
        ...
        public static SkillName[][] _AlacrityTable = new SkillName[][]
           {
                ...
                new SkillName[] { SkillName.DetectHidden, SkillName.Fencing, SkillName.Hiding, SkillName.Lockpicking, SkillName.Poisoning, SkillName.RemoveTrap, SkillName.Snooping, SkillName.Stealing, SkillName.Equitation },
...
/*                       if (deco is SkullGnarledStaff || deco is SkullLongsword)
  ...
  /*          #region Magic Equipment
        ...
        private static Type MutateType(Type type, TreasureFacet facet)
        {
            ...
            {
                type = typeof(SkullGnarledStaff);
            }
            else if (type == typeof(SkullLongsword))
            {
                type = typeof(SkullLongsword);
            }
