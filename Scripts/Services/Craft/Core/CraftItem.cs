...
namespace Server.Engines.Craft
{
    ...
    public class CraftItem
    {
        ...
        private static readonly Type[][] ItemTypesTable =
        {
            ...
            new[] {typeof(PlainoisLeather), typeof(PlainoisHides)},
            new[] {typeof(ForestierLeather), typeof(ForestierHides) },
            new[] {typeof(DesertiqueLeather), typeof(DesertiqueHides) },
            new[] {typeof(CollinoisLeather), typeof(CollinoisHides) },
			new[] {typeof(SavanoisLeather), typeof(SavanoisHides) },
			new[] {typeof(ToundroisLeather), typeof(ToundroisHides) },
			new[] {typeof(TropicauxLeather), typeof(TropicauxHides) },
			new[] {typeof(MontagnardLeather), typeof(MontagnardHides) },
        ...
        private static readonly Dictionary<Type, Type> m_ResourceConversionTable = new Dictionary<Type, Type>()
        {
            ...
            { typeof(PlainoisLeather), typeof(PlainoisHides) },
            { typeof(ForestierLeather), typeof(ForestierHides) },
            { typeof(DesertiqueLeather), typeof(DesertiqueHides) },
            { typeof(CollinoisLeather), typeof(CollinoisHides) },
			{ typeof(SavanoisLeather), typeof(SavanoisHides) },
			{ typeof(ToundroisLeather), typeof(ToundroisHides) },
			{ typeof(TropicauxLeather), typeof(TropicauxHides) },
			{ typeof(MontagnardLeather), typeof(MontagnardHides) },
