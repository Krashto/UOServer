...
namespace Server.Items
{
    ...
    public class Corpse : Container, ICarvable
    {
		...
		private bool m_PourrissementSpellDone;

		[CommandProperty(AccessLevel.GameMaster)]
		public bool PourrissementSpellDone
		{
			get { return m_PourrissementSpellDone; }
			set { m_PourrissementSpellDone = value; }
		}
		...
		public bool InBones
		{
			get
			{
				return ItemID >= 0xECA && ItemID <= 0xED2;
			}
		}
        ...
        public override void Serialize(GenericWriter writer)
        {
			...
			//Version 13
			writer.Write((bool)m_PourrissementSpellDone);
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            switch (version)
            {
				case 13:
					{
						m_PourrissementSpellDone = reader.ReadBool();
						goto case 12;
					}
				case 12:
                    {
