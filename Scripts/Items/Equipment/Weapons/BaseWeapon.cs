    ...
    public class BaseWeapon : Item, IWeapon, IUsesRemaining, ICraftable, ISlayer, IDurability, ISetItem, IVvVItem, IOwnerRestricted, IResource, IArtifact, ICombatEquipment, IEngravable, IQuality
    {
        ...
        */
        ...
        public virtual void OnHit(Mobile attacker, IDamageable damageable, double damageBonus)
        {
            ...
            bool ignoreArmor = (a is ArmorIgnore || (bladeweaving && weavabil is ArmorIgnore));
        ...
        public virtual void DoDispel(Mobile attacker, Mobile defender)
        {
			...
			DispelSpell sp = new DispelSpell(attacker, null);
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (m_AosWeaponAttributes.UseBestSkill == 0)
            {
                switch (Skill)
                {
					...
					case SkillName.Wrestling:
						list.Add("Skill Required: Wrestling"); // skill required: throwing
						break;
                }
            }
			...
			var typeName = NewWeaponInfo.GetTypeName(this);
