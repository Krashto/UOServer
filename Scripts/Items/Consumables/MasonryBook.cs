...
namespace Server.Items
{
    public class MasonryBook : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else if (pm.Skills[SkillName.Tinkering].Base < 50.0)
          {
				pm.SendMessage("Vous devez avoir 50.0 dans votre skill de Tinkering"); // Only a Grandmaster Carpenter can learn from this book.
			}
            else if (pm.Masonry)
            {
