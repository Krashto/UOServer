...
namespace Server.Mobiles
{
    ...
    public class SlasherOfVeils : BaseSABoss
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            SetSkill(SkillName.Tracking, 127.1);
        ...
        public override Type[] UniqueSAList => new[] { typeof(ClawsOfTheBerserker), typeof(Lavaliere), typeof(Mangler), typeof(HumanSignOfChaos), typeof(SignOfChaos), typeof(StandardOfChaosG), typeof(StandardOfChaos) };
