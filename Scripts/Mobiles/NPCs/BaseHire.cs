...
namespace Server.Mobiles
{
	public class BaseHire : BaseCreature
	{
		...
		private CorpulenceEnum m_Grosseur;
			...
			: base(AI, FightMode.Aggressor, 10, 1, 0.1, 4.0)
		{
			...
			Grosseur = (CorpulenceEnum)Utility.Random(1,8);
				...
				case 2:
					{
						...
						m_Grosseur = (CorpulenceEnum)reader.ReadInt();
	...
	*/
	...
	//		PayTimer.RemoveTimer(this);
		...
		public string GrosseurString()
		{
			...
			CorpulenceEnum gros = m_Grosseur;
