...
/*
    ...
    public class BaseCreature : Mobile, IHonorTarget, IEngravable
    {
		...
		{
			if (!(m is BaseCreature) || ((BaseCreature)m).ExpGiven == 5 || !((BaseCreature)m).JakoIsEnabled || ((BaseCreature)m).Summoned)
				return;
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            if (IsAnimatedDead)
            {
				ReanimationSpell.Register(m_SummonMaster, this);
            }
