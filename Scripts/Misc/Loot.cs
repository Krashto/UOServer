   ...
   //         typeof(Ring)
      ...
      //  public static Type[] SAJewelryTypes => m_SAJewelryTypes;
       ...
       /*     if (isStygian)
        ...
        public static BlankScroll RandomScroll(int minIndex, int maxIndex, SpellbookType type)
        {
			var types = new Type[] { typeof(BlankScroll) };

            return Construct(types, Utility.RandomMinMax(minIndex, maxIndex)) as BlankScroll;
