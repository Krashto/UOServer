        ...
        public static void Run()
        {
            ...
            foreach (Item item in World.Items.Values)
            {
                ...
                else if ((item.Layer == Layer.Hair || item.Layer == Layer.FacialHair))
                {
                    ...
                    {
                        Mobile rooCustomPlayerMobile = (Mobile)rootParent;
                        if (item.Parent != rooCustomPlayerMobile && rooCustomPlayerMobile.IsPlayer())
                        {
                            items.Add(item);
                            continue;
                        }
                        else if (item.Parent == rooCustomPlayerMobile)
                        {
                            hairCleanup.Add(rooCustomPlayerMobile);
                            continue;
                        }
                    }
                }
