...
{
    public class HumilityQuesCustomPlayerMobile : BaseVendor
    {
        ...
        public HumilityQuesCustomPlayerMobile(string name) : base(null)
        {
            Name = name;
            m_NextGreet = DateTime.UtcNow;
        }

        public HumilityQuesCustomPlayerMobile(string name, string title) : base(title)
        {
            Name = name;
            m_NextGreet = DateTime.UtcNow;
        }

        public static List<HumilityQuesCustomPlayerMobile> Instance => m_Instances;
        private static readonly List<HumilityQuesCustomPlayerMobile> m_Instances = new List<HumilityQuesCustomPlayerMobile>();

        public HumilityQuesCustomPlayerMobile(Serial serial) : base(serial)
        {
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (quest != null && pm.Backpack != null && !quest.HasGivenTo(this))
            {
                ...
                {
                    int idx = HumilityQuesCustomPlayerMobileInfo.GetNPCIndex(GetType());
    ...
    public class HumilityQuesCustomPlayerMobileInfo
    {
        ...
        public HumilityQuesCustomPlayerMobileInfo(Type needs, Type gives, int needsLoc, int givesLoc)
        {
            m_Needs = needs;
            m_Gives = gives;
            m_NeedsLoc = needsLoc;
        ...
        public HumilityQuesCustomPlayerMobileInfo(GenericReader reader)
        {
            int version = reader.ReadInt();
