...
namespace Server.Engines.Quests
{
    ...
    public class WhosMostHumbleQuest : BaseQuest
    {
        ...
        private readonly Dictionary<int, HumilityQuesCustomPlayerMobileInfo> m_Infos = new Dictionary<int, HumilityQuesCustomPlayerMobileInfo>();
        public Dictionary<int, HumilityQuesCustomPlayerMobileInfo> Infos => m_Infos;
        ...
        public override void OnAccept()
        {
            ...
            List<Type> itemTypes = new List<Type>(HumilityQuesCustomPlayerMobileInfo.ItemTypes);
            List<Type> mobTypes = new List<Type>(HumilityQuesCustomPlayerMobileInfo.MobileTypes);
            ...
            {
                int mobIndex = HumilityQuesCustomPlayerMobileInfo.GetNPCIndex(mobTypes[i]);
                int need = i;
                int give = need + 1;
                ...
                m_Infos[mobIndex] = new HumilityQuesCustomPlayerMobileInfo(needs, gives, HumilityQuesCustomPlayerMobileInfo.GetLoc(needs), HumilityQuesCustomPlayerMobileInfo.GetLoc(gives));
            }
        }
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            foreach (KeyValuePair<int, HumilityQuesCustomPlayerMobileInfo> kvp in m_Infos)
            {
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                m_Infos[mobIndex] = new HumilityQuesCustomPlayerMobileInfo(reader);
            }
