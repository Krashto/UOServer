...
namespace Server.Engines.Quests
{
    ...
    {
        private readonly HumilityQuesCustomPlayerMobile m_Mobile;
        private readonly WhosMostHumbleQuest m_Quest;
        private readonly int m_NPCIndex;

        public HumilityItemQuestGump(HumilityQuesCustomPlayerMobile mobile, WhosMostHumbleQuest quest, int index) : base(50, 50)
        {
            m_Mobile = mobile;
            m_Quest = quest;
            m_NPCIndex = index;
