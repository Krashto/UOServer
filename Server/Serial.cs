...
namespace Server
{
	public struct Serial : IComparable, IComparable<Serial>
	{
		...
		private static Serial m_LasCustomPlayerMobile = Zero;
		private static Serial m_LastItem = 0x40000000;

		public static Serial LasCustomPlayerMobile => m_LasCustomPlayerMobile;
		...
		public static Serial NewMobile
		{
			get
			{
				while (World.FindMobile(m_LasCustomPlayerMobile = m_LasCustomPlayerMobile + 1) != null)
				{
					;
				}

				return m_LasCustomPlayerMobile;
			}
		}
